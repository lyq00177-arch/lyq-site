...
const categories: Category[] = [
  ...
  },
  {
    ...
    perks: [
      {
        name: "XueDingToken API 中转站",
        benefit: "国内直连 Claude / GPT",
        desc: "稳定访问 Claude、GPT 等主流模型的 API 中转服务，价格透明、国内直连，适合开发者和重度 AI 用户。",
        link: "https://shop.xuedingtoken.com/?dist=SPRVDM6N",
        code: "SPRVDM6N",
      },
      {
        name: "西部数据",
        benefit: "魔法上网 · 稳定多节点",
        desc: "高速稳定访问 GitHub、Google、ChatGPT 等海外服务，多线路节点，开发者与 AI 用户必备。",
        link: "https://wd-gold.net/aff.php?aff=12495",
      },
      {
        name: "MTCGAME 礼品卡",
        benefit: "全球礼品卡 · 苹果礼品卡",
        desc: "购买全球各国 App Store / iTunes、Google Play 等礼品卡，支持跨区充值，海外账号与应用订阅必备。",
        link: "https://www.mtcgame.com/zh/itunes-gift-cards",
      },
    ],
  },
  {
    ...
    perks: [
      ...
      {
        name: "Trae",
        desc: "字节跳动出品的 AI 原生 IDE，中文友好、国内直连，免费好用，Cursor 的国产平替。",
  ...
  },
  {
    ...
    perks: [
      {
        name: "Bitget UCard 优卡",
        benefit: "数字资产直接消费",
        desc: "用 USDT 等数字资产直接消费的虚拟卡，绑定后线上线下刷卡支付，免去频繁出金，便捷的加密支付解决方案。",
